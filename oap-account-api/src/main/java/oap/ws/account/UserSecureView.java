...
public class UserSecureView extends UserView {
    ...
    public UserSecureView( String email, String firstName, String lastName, Map<String, List<String>> accounts,
        ...
        super( email, firstName, lastName, accounts, roles, banned, confirmed, tfaEnabled, defaultAccounts, defaultOrganization, lastLogin,
            created, modified );
